  ...
  return (
    <div className="dashboard">
      <header className="header">
        ...
        <div className="user-info">
          ...
          <div className="status">
            ...
            <div className="online">狀態：在線</div>
          </div>
      ...
      <style jsx>{`
        ...
        .upload-card p { margin-bottom: 12px; color: #555; }
        .loading-text { color: #6F4E37; margin-top: 10px; }
        .submit-btn-wrapper { margin-top: 12px; }
        .submit-btn {
          padding: 10px 20px;
          background: #c26624ff;
          color: #000;
        ...
        .submit-btn:disabled { background: #d6874eff; cursor: not-allowed; }
        .tips { margin-top: 20px; font-size: 0.85rem; color: #666; text-align: left; }
        .footer {
          position: fixed;
          bottom: 0;
          left: 0;
        ...
        @media (max-width: 768px) {
          ...
          .upload-card { margin: 160px 10px 0 10px; padding: 15px; }
        }
